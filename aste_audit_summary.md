# ASTE Data QA Report
**Input**: data_train_v8_aste.modifier_auto_merged.jsonl
**Corrected Output**: data_train_v8_aste.modifier_auto_merged.qa_fixed.jsonl
**Total records**: 7565
**Records có lỗi**: 3217 (42.52%)
...
| 27 | Aspect sai | aspect: General | aspect: Ship | Target/opinion khớp mạnh với nhóm Ship qua keyword "đóng gói". |
...
| 45 | Span lệch | opinion: "" [-1, -1] | opinion: "" [-1, -1] | Span nằm ngoài độ dài text và không có cách sửa chắc chắn. |
| 46 | Span lệch | opinion: "" [-1, -1] | opinion: "" [-1, -1] | Span nằm ngoài độ dài text và không có cách sửa chắc chắn. |
| 47 | Span lệch | opinion: "" [-1, -1] | opinion: "" [-1, -1] | Span nằm ngoài độ dài text và không có cách sửa chắc chắn. |
| 48 | Span lệch | opinion: "khá tốt" [431, 439] | opinion: "khá tốt" [431, 438] | Span không khớp exact substring trong text; tìm thấy match gần nhất tại [431, 438]. |
| 49 | Span lệch | opinion: "" [-1, -1] | opinion: "" [-1, -1] | Span nằm ngoài độ dài text và không có cách sửa chắc chắn. |
| 50 | Span lệch | opinion: "" [-1, -1] | opinion: "" [-1, -1] | Span nằm ngoài độ dài text và không có cách sửa chắc chắn. |
