...
# Configuration
INPUT_FILE = "/home/uph3hc/project/mlops-sentiment-pipeline/data/processed/train_final_v9_CLEANED.jsonl"
OUTPUT_ERRORS = "/home/uph3hc/project/mlops-sentiment-pipeline/data/processed/audit_errors_cleaned.jsonl"
OUTPUT_CLEAN = "/home/uph3hc/project/mlops-sentiment-pipeline/data/processed/triplet_data_absolutely_clean.jsonl"
...
def main():
    print("🔍 Auditing cleaned dataset...")
    ...
    # Print report
    print("=" * 70)
    print("AUDIT REPORT (CLEANED DATASET)".center(70))
    print("=" * 70)
    ...
    print("=" * 70)
    if clean_record_count == total_records:
        print(f"Status: ✅ PERFECT! All {total_records} records are clean!".center(70))
    else:
        ratio = 100*clean_record_count/max(total_records,1)
        if ratio >= 95:
            print(f"Status: ✅ EXCELLENT ({ratio:.1f}% clean)".center(70))
        elif ratio >= 85:
            print(f"Status: ✅ GOOD ({ratio:.1f}% clean)".center(70))
        else:
            print(f"Status: ⚠ NEEDS REVIEW".center(70))
    print("=" * 70)
    print()
    print(f"📁 Errors logged to: {OUTPUT_ERRORS}")
    print(f"📁 Absolutely clean records saved to: {OUTPUT_CLEAN}")
    print()
