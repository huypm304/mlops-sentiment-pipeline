...
**File**: data_train_v6_1.jsonl
**Total records**: 7565
**Records co loi**: 273 (3.61%)
...
| E5 | Sentiment sai ro rang | 155 | 2.05% |
| E6 | Global conflict aspect | 118 | 1.56% |
...
- line 401: target="sóng" | context="sóng căng vứt" | predict=1 | nen la 2

### E6 - Global conflict
- line 214: aspects=[1] | global=0
- line 427: aspects=[1] | global=0
- line 711: aspects=[1] | global=0
- line 726: aspects=[1] | global=0
- line 769: aspects=[1] | global=0
...
1. Ra soat Sentiment sai ro rang (155 records) truoc khi train lai vi no lam lech sentiment head.
2. Can tach va kiem tra Global conflict aspect (118 records) vi global head dang hoc tu nhan mau thuan.
